...
// Ordered by real-world frequency (3.3 is by far the most common, 3.4 is newer)
const VERSIONS_TO_TRY  = ['3.3', '3.4', '3.1', '3.5'];
const PER_VERSION_MS   = 4000; // max time to wait for connect + first response per version
