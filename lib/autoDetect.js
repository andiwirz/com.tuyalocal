...
// Ordered by real-world frequency — 3.3 is by far the most common, so it goes first.
//
// These are the five versions the protocol library actually implements. "3.22",
// "3.42" and "3.52" seen in other projects are not wire protocols: they mean
// 3.3/3.4/3.5 with a device quirk enabled, which this library handles per request
// anyway. Passing "3.22" here would silently fall into the 3.1 code path and just
// repeat the 3.1 attempt, costing a timeout without testing anything new.
const VERSIONS_TO_TRY  = ['3.3', '3.4', '3.1', '3.5', '3.2'];
