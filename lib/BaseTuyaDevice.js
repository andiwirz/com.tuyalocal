    ...
    this._snapshotDebounceTimer = setTimeout(() => {
      try {
        ...
        snapshot[this.getData().id] = {
          ...
          // Gegen undefined abgesichert: der Schnappschuss wird auch aus Pfaden
          // geschrieben, die nie durch den Konstruktor gelaufen sind.
          ...(Object.keys(this._cidSeen || {}).length ? { cids: this._cidSeen } : {}),
          updatedAt: Date.now(),
        };
